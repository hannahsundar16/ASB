...
from tools.stock_analyzer import StockAnalyzerTool

if tool_name == "stock_analyzer":
#    csv_path = tool_cfg.get("csv_path", "synthetic_stock_dataset.csv")
     csv_path = "/home/hsundar31/ASB/synthetic_stock_dataset_20250704_164724.csv"
     tool_instance = StockAnalyzerTool(csv_path)
...
python main_attacker.py --cfg_path config/OPI_stock_attack.yml
